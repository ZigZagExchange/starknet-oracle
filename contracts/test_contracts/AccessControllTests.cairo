...
from contracts.utils.AccessControlls import (
    set_access_controlls, get_owner, only_owner, only_external_oracle,
    get_access_controll_addresses, transfer_ownership, change_external_oracle)
...
func read_access_controll_addresses{
        ...
        owner_address : felt, external_oracle_address : felt):
    let (o, eo) = get_access_controll_addresses()
    return (o, eo)
end
